...
#house.exit <- read.dta("/home/carlisle/Desktop/PObs/APSA/Data/US_92_exit_polls.dta")
house.exit <- read.dta("Data/Senate_appended_stacked_state_exit_polls_92.dta")
#nes92 <- read.dta("/home/carlisle/Desktop/PObs/APSA/Data/Carlisle_1992_ANES_supplemented.dta")
...
plot(NULL, xlim = c(0, 1), ylim = c(3, 8), xlab = NA, ylab = NA, axes = F)
axis(side = 1)
